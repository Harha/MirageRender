...
Film::Film(int resolutionX, int resolutionY) : m_resolutionX(resolutionX), m_resolutionY(resolutionY), m_aspectRatio(static_cast<float>(m_resolutionX) / m_resolutionY)
{
...
std::vector<Sample> Film::getSamples() const
{
    return m_samples;
}
